(() => {
    ...
    (() => {
        ...
        document.querySelector(".headerAlt__langBtn");
        document.querySelector(".promo__langMenu");
        document.querySelector(".uaBtn");
        document.querySelector(".enBtn");
        document.getElementById("langImg");
        document.getElementById("promo__uaVideo");
        ...
        const languages_langMenuBtn = document.querySelector(".headerAlt__langBtn");
        const languages_langMenu = document.querySelector(".promo__langMenu");
        const languages_langUABtn = document.querySelector(".uaBtn");
        const languages_langENBtn = document.querySelector(".enBtn");
        const languages_langImg = document.getElementById("langImg");
        const languages_promoUaVid = document.getElementById("promo__uaVideo");
        const languages_promoEnVid = document.getElementById("promo__enVideo");
        const languages_promoUaLink = document.getElementById("promo__uaLink");
        const languages_promoEnLink = document.getElementById("promo__enLink");
        ...
        function languageDetection() {
            ...
            if (userLang === "en") {
                languages_langImg.src = "img/en.svg";
                languages_promoEnVid.style.display = "flex";
                languages_promoUaVid.style.display = "none";
                languages_promoEnLink.style.display = "flex";
                languages_promoUaLink.style.display = "none";
            } else {
                languages_langImg.src = "img/ua.svg";
                languages_promoEnVid.style.display = "none";
                languages_promoUaVid.style.display = "flex";
                languages_promoUaLink.style.display = "flex";
                languages_promoEnLink.style.display = "none";
            }
        ...
        languageDetection();
        languages_langMenuBtn.addEventListener("click", (function(e) {
            e.stopPropagation();
            languages_langMenu.classList.toggle("block");
            languages_langMenuBtn.classList.toggle("toggleLangBtn");
        }));
        document.addEventListener("click", (function(event) {
            if (event.target !== languages_langMenu) {
                languages_langMenu.classList.remove("block");
                languages_langMenuBtn.classList.remove("toggleLangBtn");
            }
        }));
        function changeToUA() {
            let currentImg = languages_langImg.src;
            let uaFlag = "img/ua.svg";
            let newImg = currentImg = uaFlag;
            languages_langImg.src = newImg;
            languages_promoUaVid.style.display = "flex";
            languages_promoEnVid.style.display = "none";
            languages_promoUaLink.style.display = "flex";
            languages_promoEnLink.style.display = "none";
        ...
        languages_langUABtn.addEventListener("click", (function(e) {
            e.stopPropagation();
            languages_langMenu.classList.remove("block");
            languages_langMenuBtn.classList.remove("toggleLangBtn");
            changeToUA();
        ...
        languages_langENBtn.addEventListener("click", (function(e) {
            e.stopPropagation();
            languages_langMenu.classList.remove("block");
            languages_langMenuBtn.classList.remove("toggleLangBtn");
            changeToEN();
