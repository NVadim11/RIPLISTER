    ...
    (() => {
        ...
        ajaxhttp.onreadystatechange = function() {
            if (ajaxhttp.readyState == 4 && ajaxhttp.status == 200) {
                ...
                document.addEventListener("submit", login_formValidate);
                let i;
        ...
        const generateError = (errorName, errorMsg) => {
            ...
            if (errorName == "email") emailError.innerText = errorMsg; else if (errorName == "password") passwordError.innerText = errorMsg;
        };
        const login_formValidate = (inputEmail, inputPassword) => {
