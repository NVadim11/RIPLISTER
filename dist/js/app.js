(() => {
    ...
    (() => {
        ...
        document.querySelector("uaVideo");
        document.querySelector("enVideo");
        document.querySelector("uaLink");
        document.querySelector("enLink");
        ...
        if (pathnameProfile === currentPageProfile) languageDetection();
