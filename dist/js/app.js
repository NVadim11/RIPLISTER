    ...
    (() => {
        ...
        class PopupPromo {
            constructor(options) {
                let config = {
                    ...
                    classes: {
                        ...
                        popupActive: "promoPopup_show",
                        bodyActive: "promoPopup-show"
                    },
                    focusCatch: true,
                    closeEsc: true,
                    bodyLock: true,
            ...
            eventsPopup() {
                document.addEventListener("click", function(e) {
                    ...
                    if (buttonOpen) {
                        ...
                        this.youTubeCode = buttonOpen.getAttribute(this.options.youtubeAttributePromo) ? buttonOpen.getAttribute(this.options.youtubeAttributePromo) : null;
                    ...
                    if (this.targetOpen.element) {
                        if (this.youTubeCode) {
                            ...
                            if (!this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttributePromo}]`)) {
                                this.targetOpen.element.querySelector(".promoPopup__text").setAttribute(`${this.options.youtubePlaceAttributePromo}`, "");
                            }
            ...
            close(selectorValue) {
                ...
                if (this.youTubeCode) if (this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttributePromo}]`)) this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttributePromo}]`).innerHTML = "";
        ...
        class PopupVideo {
            constructor(options) {
                let config = {
                    ...
                    classes: {
                        ...
                        popupActive: "popupVideo_show",
                        bodyActive: "popupVideo-show"
                    },
                    focusCatch: true,
                    closeEsc: true,
                    bodyLock: true,
            ...
            eventsPopup() {
                document.addEventListener("click", function(e) {
                    ...
                    if (buttonOpen) {
                        e.preventDefault();
                        this._dataValue = buttonOpen.getAttribute(this.options.attributeOpenButton) ? buttonOpen.getAttribute(this.options.attributeOpenButton) : "error";
                        this.youTubeCode = buttonOpen.getAttribute(this.options.youtubeAttributeVideo) ? buttonOpen.getAttribute(this.options.youtubeAttributeVideo) : null;
                        if (this._dataValue !== "error") {
                            if (!this.isOpen) this.lastFocusEl = buttonOpen;
                            this.targetOpen.selector = `${this._dataValue}`;
                            this._selectorOpen = true;
                    ...
                    if (this.targetOpen.element) {
                        if (this.youTubeCode) {
                            ...
                            if (!this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttributeVideo}]`)) {
                                this.targetOpen.element.querySelector(".popupVideo__text").setAttribute(`${this.options.youtubePlaceAttributeVideo}`, "");
                            }
            ...
            close(selectorValue) {
                ...
                if (this.youTubeCode) if (this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttributeVideo}]`)) this.targetOpen.element.querySelector(`[${this.options.youtubePlaceAttributeVideo}]`).innerHTML = "";
                this.previousOpen.element.classList.remove(this.options.classes.popupActive);
                this.previousOpen.element.setAttribute("aria-hidden", "true");
                if (!this._reopen) {
                    document.documentElement.classList.remove(this.options.classes.bodyActive);
            ...
            constructor(options) {
                let config = {
                    ...
                    classes: {
                        ...
                        popupActive: "popupThanks_show",
                        bodyActive: "popupThanks-show"
                    },
                    focusCatch: true,
                    closeEsc: true,
                    bodyLock: true,
        ...
        if (pathname === currentPage) languageDetection();
